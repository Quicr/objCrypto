...
TEST_CASE("test AES128 CTR IV Mode") {
    ...
    std::vector<uint8_t> plainTextIn = {0x6b, 0xc1, 0xbe, 0xe2, 0x2e, 0x40, 0x9f, 0x96, 0xe9, 0x3d,
    ...
    std::vector<uint8_t> correct = {0x87, 0x4d, 0x61, 0x91, 0xb6, 0x20, 0xe3, 0x26, 0x1b, 0xef,
