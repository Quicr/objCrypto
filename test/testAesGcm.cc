...
TEST_CASE("test 4 AES 128 GCM Mode") {
    ...
    Nonce nonce = {0xCA, 0xFE, 0xBA, 0xBE, 0xFA, 0xCE, 0xDB, 0xAD, 0xDE, 0xCA, 0xF8, 0x88};
    ...
    std::vector<uint8_t> authData = {0xFE, 0xED, 0xFA, 0xCE, 0xDE, 0xAD, 0xBE, 0xEF, 0xFE, 0xED,
    ...
    std::vector<uint8_t> correctTag = {0x5B, 0xC9, 0x4F, 0xBC, 0x32, 0x21, 0xA5, 0xDB,
...
TEST_CASE("test 16 AES 256 GCM Mode") {
    ...
    Key256 key256 = {0xFE, 0xFF, 0xE9, 0x92, 0x86, 0x65, 0x73, 0x1C, 0x6D, 0x6A, 0x8F,
    ...
    std::vector<uint8_t> correctTag = {0x76, 0xFC, 0x6E, 0xCE, 0x0F, 0x4E, 0x17, 0x68,
