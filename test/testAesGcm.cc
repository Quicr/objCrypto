...
TEST_CASE("test 1 AES128 GCM IV Mode") {
    ...
    std::vector<uint8_t> correctTag = {0x58, 0xe2, 0xfc, 0xce, 0xfa, 0x7e, 0x30,
0x61, 0x36, 0x7f, 0x1d, 0x57, 0xa4, 0xe7, 0x45, 0x5a};
...
TEST_CASE("test 2 AES128 GCM IV Mode")  {
    ...
    std::vector<uint8_t> plainTextIn = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
    std::vector<uint8_t> authData = {};
    std::vector<uint8_t> correct = {0x03, 0x88, 0xda, 0xce, 0x60, 0xb6, 0xa3,
0x92, 0xf3, 0x28, 0xc2, 0xb9, 0x71, 0xb2, 0xfe, 0x78}; std::vector<uint8_t>
correctTag = {0xab, 0x6e, 0x47, 0xd4, 0x2c, 0xec, 0x13, 0xbd, 0xf5, 0x3a, 0x67,
...
TEST_CASE("test 4 AES 128 GCM Mode") {
  ...
  std::vector<uint8_t> correctTag = {0x5B, 0xC9, 0x4F, 0xBC, 0x32, 0x21,
...
TEST_CASE("test 16 AES 256 GCM Mode") {
  ...
  Key256 key256 = {0xFE, 0xFF, 0xE9, 0x92, 0x86, 0x65, 0x73, 0x1C,
                   0x6D, 0x6A, 0x8F, 0x94, 0x67, 0x30, 0x83, 0x08,
  ...
  std::vector<uint8_t> correctTag = {0x76, 0xFC, 0x6E, 0xCE, 0x0F, 0x4E,
  ...
  SUBCASE("tag size 64 bits") {
    KeyInfo smallKeyInfo(ObjCryptoAlg::AES_256_GCM_64, key256);
    keyInfo = smallKeyInfo;
