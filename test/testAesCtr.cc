...
TEST_CASE("test AES 256 Ctr Mode") {
    ...
    Key256 key256 = {0xF6, 0xD6, 0x6D, 0x6B, 0xD5, 0x2D, 0x59, 0xBB, 0x07, 0x96, 0x36,
    ...
    Nonce nonce = {0x00, 0xFA, 0xAC, 0x24, 0xC1, 0x58, 0x5E, 0xF1, 0x5A, 0x43, 0xD8, 0x75};

    std::vector<uint8_t> correct = {0xF0, 0x5E, 0x23, 0x1B, 0x38, 0x94, 0x61, 0x2C,
