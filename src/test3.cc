...
int ctr_encrypt(unsigned char *plaintext, int plaintext_len, unsigned char *aad, int aad_len,
    ...
    status = CCCryptorUpdate(cryptorRef, plaintext,
                             plaintext_len,  // const void *dataIn, size_t dataInLength,
...
int ctr_decrypt(unsigned char *ciphertext, int ciphertext_len, unsigned char *aad, int aad_len,
    ...
    status = CCCryptorUpdate(cryptorRef, ciphertext,
                             ciphertext_len, // const void *dataIn, size_t dataInLength,
